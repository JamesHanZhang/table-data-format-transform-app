...
def init_same_struct_mode_params() -> tuple[str, str, str, str, str, str, str, str]:
    ...
    return input_file, input_path , input_sep, input_encoding, output_file, output_path, output_sep, output_encoding


def run_same_struct_mode():
    input_file, input_path , input_sep, input_encoding, output_file, output_path, output_sep, output_encoding = init_same_struct_mode_params()
